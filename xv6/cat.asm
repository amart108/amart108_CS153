...
cat(int fd)
{
  ...
  1e:	e8 a1 03 00 00       	call   3c4 <write>
void
cat(int fd)
{
  int n;
  ...
  39:	e8 7e 03 00 00       	call   3bc <read>
  ...
  4d:	c7 44 24 04 00 09 00 	movl   $0x900,0x4(%esp)
  54:	00 
...
main(int argc, char *argv[])
{
  ...
  c0:	e8 1f 03 00 00       	call   3e4 <open>
  ...
  e6:	c7 44 24 04 11 09 00 	movl   $0x911,0x4(%esp)
  ed:	00 
  ee:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  f5:	e8 3a 04 00 00       	call   534 <printf>
      exit(1);
 ...
 119:	e8 ae 02 00 00       	call   3cc <close>
  if(argc <= 1){
    cat(0);
    exit(1);
  }
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4cd:	0f b6 80 94 0b 00 00 	movzbl 0xb94(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 62a:	75 09                	jne    635 <printf+0x101>
          s = "(null)";
 62c:	c7 45 f4 26 09 00 00 	movl   $0x926,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f6:	a1 c8 0b 00 00       	mov    0xbc8,%eax
...
free(void *ap)
{
 ...
 7c1:	a3 c8 0b 00 00       	mov    %eax,0xbc8
}
 7c6:	c9                   	leave  
 7c7:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7e7:	e8 40 fc ff ff       	call   42c <sbrk>
 ...
 814:	e8 ce fe ff ff       	call   6e7 <free>
  return freep;
 819:	a1 c8 0b 00 00       	mov    0xbc8,%eax
}
 81e:	c9                   	leave  
 81f:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 832:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 835:	a1 c8 0b 00 00       	mov    0xbc8,%eax
 83a:	89 45 f0             	mov    %eax,-0x10(%ebp)
 83d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 841:	75 23                	jne    866 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 843:	c7 45 f0 c0 0b 00 00 	movl   $0xbc0,-0x10(%ebp)
 84a:	8b 45 f0             	mov    -0x10(%ebp),%eax
 84d:	a3 c8 0b 00 00       	mov    %eax,0xbc8
 852:	a1 c8 0b 00 00       	mov    0xbc8,%eax
 857:	a3 c0 0b 00 00       	mov    %eax,0xbc0
    base.s.size = 0;
 85c:	c7 05 c4 0b 00 00 00 	movl   $0x0,0xbc4
 863:	00 00 00 
  }
 ...
 8b9:	a3 c8 0b 00 00       	mov    %eax,0xbc8
      return (void*)(p + 1);
 ...
 8c4:	eb 38                	jmp    8fe <malloc+0xde>
    ...
    if(p == freep)
 8c6:	a1 c8 0b 00 00       	mov    0xbc8,%eax
