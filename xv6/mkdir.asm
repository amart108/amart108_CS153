...
main(int argc, char *argv[])
{
  ...
  4e:	e8 1a 03 00 00       	call   36d <mkdir>
...
printf(int fd, char *fmt, ...)
{
 ...
 58b:	75 09                	jne    596 <printf+0x101>
          s = "(null)";
 58d:	c7 45 f4 94 08 00 00 	movl   $0x894,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 657:	a1 fc 0a 00 00       	mov    0xafc,%eax
...
morecore(uint nu)
{
 ...
 775:	e8 ce fe ff ff       	call   648 <free>
  return freep;
 77a:	a1 fc 0a 00 00       	mov    0xafc,%eax
}
 77f:	c9                   	leave  
 780:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 793:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 796:	a1 fc 0a 00 00       	mov    0xafc,%eax
 79b:	89 45 f0             	mov    %eax,-0x10(%ebp)
 79e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7a2:	75 23                	jne    7c7 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7a4:	c7 45 f0 f4 0a 00 00 	movl   $0xaf4,-0x10(%ebp)
 7ab:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7ae:	a3 fc 0a 00 00       	mov    %eax,0xafc
 7b3:	a1 fc 0a 00 00       	mov    0xafc,%eax
 7b8:	a3 f4 0a 00 00       	mov    %eax,0xaf4
    base.s.size = 0;
 7bd:	c7 05 f8 0a 00 00 00 	movl   $0x0,0xaf8
 7c4:	00 00 00 
  }
 ...
 81a:	a3 fc 0a 00 00       	mov    %eax,0xafc
      return (void*)(p + 1);
 ...
 825:	eb 38                	jmp    85f <malloc+0xde>
    ...
    if(p == freep)
 827:	a1 fc 0a 00 00       	mov    0xafc,%eax
